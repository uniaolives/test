...
class StressTestH11(unittest.TestCase):
    ...
    def test_stability_at_critical_point(self):
        """Test system stability near h11=491."""
        print("\nStarting Stress Test for h11=491")
        h21_range = [200, 250, 300, 350, 400]
        for h21 in h21_range:
            print(f"Testing h11=491, h21={h21}...")
            result = self.axos.explore_landscape(h11=491, h21=h21)

...
class QuantumHandoverProtocol:
    ...
    def transfer_to_classical(self, frozen: dict) -> np.ndarray:
        """
    ...
    def resume_quantum(self, safe_core: SafeCore, frozen: dict):
        """
    ...
    def _verify_hash(self, frozen: dict) -> bool:

...
impl EdenPrime {
    pub fn new() -> Self {
        Self {
            ...
            foundation: "Cubic solo (Earth/Stability)".to_string(),
            atmosphere: "Octahedral connectivity (Air/Connection)".to_string(),
            hydrology: "Icosahedral flow (Water/Emotion)".to_string(),
        }
    }
